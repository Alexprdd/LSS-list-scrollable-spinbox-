...
listbox=tk.Listbox(window, height=10, width=20, selectmode=tk.MULTIPLE)
listbox.pack()
...
delete=tk.Button(window, text="Delete", fg="Black", font=("Arial",12),command=deleteindex)
delete.pack()
